    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('superadmin', 'Super Admin'), ('miniadmin', 'Mini Admin'), ('acadi', 'ACADI'), ('editor', 'Editor'), ('comentarista', 'Comentarista'), ('lector', 'Lector'), ('sin_rol', 'Sin Rol')], default='sin_rol', max_length=15)),
                ('is_active', models.BooleanField(default=False)),
                ('is_staff', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(auto_now_add=True)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/', verbose_name='Foto de perfil')),
                ('avatar_drive_id', models.CharField(blank=True, max_length=100, null=True)),
